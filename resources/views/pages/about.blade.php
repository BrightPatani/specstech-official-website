...
@section('content')
    ...
    {{-- who we are  --}}
    <section class="py-16 lg:py-24 bg-[#FFFFFF] overflow-hidden">
        <div class="container mx-auto px-6 lg:px-8">
            <div class="relative flex flex-col lg:flex-row items-center">
                
                <div class="hidden lg:block w-full lg:w-1/2 z-20 lg:mb-0">
                    <div class="rounded-2xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.15)] transition-transform duration-500 hover:scale-[1.02]">
                ...
                <div class="w-full lg:w-[60%] lg:ml-[-5%] bg-[#F8FAFC] rounded-2xl p-8 lg:p-20 lg:pl-32 shadow-[0_15px_40px_rgba(0,0,0,0.04)] border border-gray-50 z-10">
                    <div class="max-w-xl mx-auto lg:mx-0">
                        <h2 class="text-[#334155] text-3xl lg:text-5xl font-bold mb-8 leading-tight text-center lg:text-left">
                            Who We Are
                        </h2>
        ...
        <div class="container mx-auto px-6 lg:px-8 max-w-6xl">
            <div class="space-y-8">
                ...
                <div class="bg-[#FFFFFF] rounded-2xl border border-blue-100 p-8 lg:p-12 shadow-[0_10px_30px_rgba(0,0,0,0.02)] transition-all hover:shadow-[0_15px_40px_rgba(10,129,203,0.05)]">
                    ...
                    <div class="pt-2">
                        <a href="#" class="inline-flex items-center gap-2 bg-[#0A81CB] hover:bg-[#086ba8] text-white px-8 py-3 rounded-lg font-semibold transition-all shadow-lg shadow-blue-100 group">
                            Become a Client
    ...
    <section class="py-20 bg-[#FFFFFF]">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16">
                ...
                <p class="text-gray-900 text-lg lg:text-xl font-medium">Meet Our Creative Expert</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-12 max-w-7xl mx-auto">
                ...
                <div class="relative group h-[450px] lg:h-[500px] w-full rounded-2xl overflow-hidden shadow-xl transition-all duration-500 hover:shadow-2xl">
                    ...
                    <div class="absolute bottom-6 left-6 right-6 bg-[#FFFFFF] rounded-xl p-5 shadow-lg flex justify-between items-center z-20 transition-transform duration-500 group-hover:-translate-y-2">
                        <div>
                            <h3 class="text-gray-900 font-bold text-lg leading-tight">{{ $member['name'] }}</h3>
