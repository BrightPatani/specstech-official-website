<footer class="bg-[#FFFFFF] pt-16 pb-8">
    <div class="container mx-auto px-6 lg:px-8">
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
            ...
            <div class="order-3 lg:order-2 col-span-2 lg:col-span-1">
            ...
            <div class="order-4 lg:order-4 col-span-2 lg:col-span-1">
                ...
                <div class="flex flex-wrap items-center gap-4 mb-8">
                    <a href="#" class="block transition-all duration-300 hover:-translate-y-1 opacity-80 hover:opacity-100">
                        <img src="{{ asset('images/socials/linkedin.png') }}" alt="LinkedIn" class="w-7 h-7 object-contain">
                    </a>
                    <a href="#" class="block transition-all duration-300 hover:-translate-y-1 opacity-80 hover:opacity-100">
                        <img src="{{ asset('images/socials/x.png') }}" alt="X" class="w-6 h-6 object-contain">
                    </a>
                    <a href="#" class="block transition-all duration-300 hover:-translate-y-1 opacity-80 hover:opacity-100">
                        <img src="{{ asset('images/socials/facebook.png') }}" alt="Facebook" class="w-7 h-7 object-contain">
                    </a>
                    <a href="#" class="block transition-all duration-300 hover:-translate-y-1 opacity-80 hover:opacity-100">
                        <img src="{{ asset('images/socials/instagram.png') }}" alt="Instagram" class="w-7 h-7 object-contain">
                    </a>
                </div>
